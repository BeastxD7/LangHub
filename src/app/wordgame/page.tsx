      ...
      <div className="w-full max-w-md bg-gray-800 bg-opacity-50 p-12 rounded-xl">
        <div className="mb-4 ">
          ...
          <select
            ...
            <option className="bg-gray-800 bg-opacity-85" value="en">
              English
            </option>
            ...
            <option className="bg-gray-800 bg-opacity-85" value="zh">
              Chinese
            </option>
        ...
        <div className="mb-4">
          ...
          <p className="text-xl mb-4 font-medium text-center text-white">
            {hint}
          </p>
          <input
            type="text"
